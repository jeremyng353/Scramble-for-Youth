...
# File: gamemaster.tcl
# Generated on: Thu Apr 07 17:39:17 2022
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "gamemaster"]} {
		puts "Project gamemaster is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists gamemaster]} {
		project_open -revision gamemaster gamemaster
	} else {
		project_new -revision gamemaster gamemaster
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "20:53:14  APRIL 06, 2022"
	...
	set_global_assignment -name SYSTEMVERILOG_FILE fillsquare.sv
	set_global_assignment -name SYSTEMVERILOG_FILE "../vga-core/vga_pll.sv"
	set_global_assignment -name SYSTEMVERILOG_FILE "../vga-core/vga_controller.sv"
	set_global_assignment -name SYSTEMVERILOG_FILE "../vga-core/vga_address_translator.sv"
	set_global_assignment -name SYSTEMVERILOG_FILE "../vga-core/vga_adapter.sv"
	set_global_assignment -name SYSTEMVERILOG_FILE mapbuilder.sv
	set_global_assignment -name SYSTEMVERILOG_FILE makegrid.sv
	set_global_assignment -name SYSTEMVERILOG_FILE gamemaster.sv
	set_global_assignment -name SYSTEMVERILOG_FILE finalgrid.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fillscreen.sv
